...
begin
  try
           ...
           ZQueryTempatLapanganid_kategori_tempat_lapagan.AsString:=EIdkattptlap.Text;
...
begin
  try
    ...
    begin
      ...
      ZQueryTempatLapangan.SQL.Text:='SELECT * FROM tempat_lapangan WHERE id_tempat_lapangan LIKE ' + cari + 'or id_kategori_tempat_lapagan LIKE' + cari + 'or nama_tempat_lapangan LIKE' + cari + 'or telp LIKE' + cari;
